...
class Ui_SettingsForm(object):
    def setupUi(self, SettingsForm):
        ...
        self.gridLayout.addWidget(self.save_btn, 6, 0, 1, 1)
        ...
        self.enable_db_box.setFont(font1)
        ...
        self.labelHotkey.setFont(font1)
        ...
        self.hotkey_edit.setFont(font1)
        ...
        self.labelHistoryLimit.setFont(font1)
        ...
        self.history_limit.setFont(font1)
